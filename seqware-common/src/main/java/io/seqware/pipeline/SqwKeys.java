...
public enum SqwKeys {
    ...
    BASIC_TEST_DB_HOST(null, Categories.TESTING, false,"Used to designate a database host for integration tests","localhost"),
    BASIC_TEST_DB_PORT(null, Categories.TESTING, false,"Used to designate a database port for integration tests","5432"),
