...
public class ProcessingRelationshipDAOHibernate extends HibernateDaoSupport implements ProcessingRelationshipDAO {
    private final Logger logger = LoggerFactory.getLogger(ProcessingRelationshipDAOHibernate.class);
    ...
    public ProcessingRelationship updateDetached(ProcessingRelationship processingRelationship) {
        ...
        try {
            ...
            logger.error("ProcessingRelationshipDAOHibernate.updateDetached IllegalAccessException or InvocationTargetException exception:",e);
        }
        return null;
    }
