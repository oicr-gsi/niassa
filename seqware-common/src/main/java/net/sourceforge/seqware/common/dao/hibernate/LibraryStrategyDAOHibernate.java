...
public class LibraryStrategyDAOHibernate extends HibernateDaoSupport implements LibraryStrategyDAO {
    private final Logger logger = LoggerFactory.getLogger(LibraryStrategyDAOHibernate.class);
    ...
    public LibraryStrategy updateDetached(LibraryStrategy strategy) {
        ...
        try {
            ...
            logger.error("LibraryStrategyDAOHibernate.updateDetached IllegalAccessException or InvocationTargetException exception:",e);
        }
        return null;
    }
