...
public class ShareWorkflowRunDAOHibernate extends HibernateDaoSupport implements ShareWorkflowRunDAO {
    private final Logger logger = LoggerFactory.getLogger(ShareWorkflowRunDAOHibernate.class);
    ...
    public ShareWorkflowRun updateDetached(ShareWorkflowRun shareWorkflowRun) {
        ...
        try {
            ...
            logger.error("ShareWorkflowRunDAOHibernate.updateDetached IllegalAccessException or InvocationTargetException exception:",e);
        }
        return null;
    }
