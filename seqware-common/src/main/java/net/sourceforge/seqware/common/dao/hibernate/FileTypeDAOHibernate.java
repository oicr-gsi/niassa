...
public class FileTypeDAOHibernate extends HibernateDaoSupport implements FileTypeDAO {
    private final Logger logger = LoggerFactory.getLogger(FileTypeDAOHibernate.class);
    ...
    public FileType updateDetached(FileType fileType) {
        ...
        try {
            ...
            logger.error("FileTypeDAOHibernate.updateDetached IllegalAccessException or InvocationTargetException exception:",e);
        }
        return null;
    }
}
