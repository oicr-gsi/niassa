...
public class OrganismDAOHibernate extends HibernateDaoSupport implements OrganismDAO {
    private final Logger logger = LoggerFactory.getLogger(OrganismDAOHibernate.class);
    ...
    public Organism updateDetached(Organism organism) {
        ...
        try {
            ...
            logger.error("OrganismDAOHibernate.updateDetached IllegalAccessException or InvocationTargetException exception:",e);
        }
        return null;
    }
