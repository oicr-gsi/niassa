 ...
 */
@RunWith(Suite.class)
@Suite.SuiteClasses({ net.sourceforge.seqware.common.business.impl.AnalysisProvenanceServiceImplTest.class,
		net.sourceforge.seqware.common.business.impl.SampleProvenanceServiceImplTest.class,
		net.sourceforge.seqware.common.business.impl.LaneProvenanceServiceImplTest.class,
...
public class HibernateTestSuite extends TestCase {
	...
	public static void setUpClass() throws Exception {
		...
		settings.put(BASIC_TEST_DB_NAME.getSettingKey(),
				"testing_" + Instant.now().toEpochMilli() + "_" + RandomStringUtils.randomAlphabetic(4).toLowerCase());
		...
		dataSource.setUrl("jdbc:postgresql://" + settings.get(BASIC_TEST_DB_HOST.getSettingKey()) + ":"
				+ settings.get(BASIC_TEST_DB_PORT.getSettingKey()) + "/"
				+ settings.get(BASIC_TEST_DB_NAME.getSettingKey()));
