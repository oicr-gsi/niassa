...
public class CommandLineToolTest {
	...
	public void addStudy() {
		...
		String[] addStudy = new String[] { "-p", "net.sourceforge.seqware.pipeline.plugins.Metadata", "--", "--table",
				"study", "--create", "--field", "title::New Test Study", "--field",
				"description::This is a test description", "--field", "accession::InternalID123", "--field",
				"center_name::Courtagen", "--field", "center_project_name::Courtagen Test Project", "--field",
				"study_type::4" };
		runner.run(addStudy);
		assertTrue(true);
	}
	...
	public void addExperiment() {
		...
		String[] addExp = new String[] { "-p", "net.sourceforge.seqware.pipeline.plugins.Metadata", "--", "--table",
				...
				"description::This is a test description", "--field", "study_accession::29830", "--field",
				"platform_id::26" };
		runner.run(addExp);
		assertTrue(true);
	}
	...
	public void genericMetadataSaver() {
		...
		PluginRunner runner = new PluginRunner();
		String[] args = new String[] { "-p", "net.sourceforge.seqware.pipeline.plugins.ModuleRunner", "--", "--module",
				"net.sourceforge.seqware.pipeline.modules.GenericMetadataSaver", "--metadata-parent-accession",
				"218886", "--", "--gms-output-file", "fastq::chemical/seq-na-fastq-gzip::./testdata/test1",
				"--gms-algorithm", "UploadLane1", "--gms-suppress-output-file-check" };
		runner.run(args);
		assertTrue(true);
